...
private_key = PrivateKey(secret=82415795305589498003082988153531328196693446478344872211098781929772307350017%prime)
...
sequence = 'ffffffff' # value doesn't matter if timelock is zero

previousTransactionId = reverse_hex_string_and_every_two_chars_to_swap_endianness('f2f051f538810a205ddf2b1478d50f929dd079550af3cce20827a38dcb9ee9be') # the previous transaction output we are trying to spend as an input https://www.blockchain.com/explorer/transactions/btc/f2f051f538810a205ddf2b1478d50f929dd079550af3cce20827a38dcb9ee9be
...
amountToSend = reverse_hex_string_and_every_two_chars_to_swap_endianness('000000000000000d') # 0.00000013 BTC  
destinationAddress = hex(base58.b58decode_int('16hP1JMinhr3pA4WeMWuNZm6rMkhfLDkjg'))[2:-8]
